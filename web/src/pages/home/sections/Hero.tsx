      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-10 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            {/* Main Headline */}
            <h1 className="font-heading font-black text-4xl sm:text-6xl md:text-7xl xl:text-8xl tracking-tight text-slate-950 uppercase leading-[1.02] mb-6">
              Sariwa <span className="text-[#0066ff]">Ba?</span>
            </h1>

            {/* Short Description */}
            <p className="font-sans font-normal text-lg sm:text-xl text-slate-600 max-w-xl leading-relaxed mb-8">
              Scan a fish and check its freshness in seconds
            </p>

            {/* CTA Buttons in Symph Style */}
            <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 w-full sm:w-auto mb-6">
              <Button
                variant="primary"
                size="lg"
          ...
          {/* Right Column: Viewfinder Preview Frame */}
          <div className="lg:col-span-6 w-full max-w-lg mx-auto lg:max-w-none">
            <div className="bg-white rounded-3xl border border-slate-200/90 shadow-2xl shadow-blue-600/8 overflow-hidden transition-all duration-300">
              
              {/* Viewfinder Top Bar */}
              <div className="px-5 py-3.5 bg-slate-50 border-b border-slate-200/70 flex items-center justify-between">
              ...
              {/* Viewfinder Viewport */}
              <div className="relative min-h-[300px] sm:min-h-[340px] bg-slate-50/50 p-6 sm:p-8 flex flex-col items-center justify-center text-center select-none overflow-hidden">
                
                {/* Geometric Corner Guides */}
                <div className="absolute top-5 left-5 w-7 h-7 border-t-2 border-l-2 border-[#0066ff] rounded-tl-lg pointer-events-none" />
                <div className="absolute top-5 right-5 w-7 h-7 border-t-2 border-r-2 border-[#0066ff] rounded-tr-lg pointer-events-none" />
                <div className="absolute bottom-5 left-5 w-7 h-7 border-b-2 border-l-2 border-[#0066ff] rounded-bl-lg pointer-events-none" />
                <div className="absolute bottom-5 right-5 w-7 h-7 border-b-2 border-r-2 border-[#0066ff] rounded-br-lg pointer-events-none" />

                {/* Laser Scan line overlay */}
                <div className="absolute inset-x-6 h-0.5 bg-gradient-to-r from-transparent via-[#0066ff] to-transparent shadow-[0_0_14px_#0066ff] opacity-70 animate-pulse pointer-events-none" />

                {/* Icon Circle */}
                <div className="w-18 h-18 rounded-2xl bg-white border border-slate-200 shadow-md flex items-center justify-center text-[#0066ff] mb-4 transition-transform duration-200 hover:scale-105">
              ...
              {/* Viewfinder Spec Bar */}
              <div className="px-5 py-3.5 bg-white border-t border-slate-100 grid grid-cols-3 divide-x divide-slate-100 text-center">
                <div>
