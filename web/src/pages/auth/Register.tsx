...
export const Register: React.FC = () => {
  const handleGoogleSignup = () => {
    // UI placeholder / scaffold - Google OAuth will be integrated here
  };

  const handleGithubSignup = () => {
    // UI placeholder / scaffold - GitHub OAuth will be integrated here
  };
      ...
      <div className="w-full max-w-md animate-blur-in-up">
        ...
        <div className="bg-white/95 backdrop-blur-md rounded-3xl border border-slate-200/90 shadow-2xl shadow-blue-600/10 p-8 sm:p-10 transition-all hover:border-[#0066ff]/40">
          ...
          <div className="flex flex-col items-center text-center mb-6">
            ...
            <h1 className="font-heading font-black text-2xl sm:text-3xl text-slate-950 tracking-tight uppercase">
              Create Account
            </h1>
            <p className="font-sans text-xs sm:text-sm text-slate-500 mt-1.5 max-w-xs leading-relaxed">
              Permanently save your seafood quality scans and analysis logs!
            </p>
          </div>

          {/* Direct OAuth Signup Options with Staggered Delays */}
          ...
          <div className="mt-8 pt-6 border-t border-slate-100 flex flex-col gap-2 text-xs text-slate-500 animate-blur-in-up delay-350">
            <div className="flex items-center gap-2">
              ...
              <span>Unlimited scan history & cloud reports</span>
            </div>
            <div className="flex items-center gap-2">
              <Sparkles size={14} className="text-[#0066ff]" />
              <span>Cross-device sync & instant export</span>
            </div>
          </div>
          ...
          <div className="mt-7 text-center text-xs font-medium text-slate-500 animate-blur-in-up delay-400">
            ...
            <Link
              to="/login"
              className="font-bold text-[#0066ff] hover:underline ml-1"
            >
              Log In
            </Link>
          </div>
